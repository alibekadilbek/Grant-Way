...
export default function Navbar({ onStartJourney }: NavbarProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-zinc-900">Grant <span className="text-blue-600">Hunter</span></span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-700 transition-all shadow-sm"
            >
              Начать путь
            </button>
          </div>
